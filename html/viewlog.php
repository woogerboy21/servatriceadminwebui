...
<body>
    ...
    <table border="1">
        ...
        <tr>
            <td style="min-width:150px">Find By Client ID</td>
            <td style="min-width:250px"><input type="text" name="client_id" placeHolder="3x4mp1e" value="<?=$_REQUEST['client_id']?>" style="width:200px; text-align: center;"></td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="min-width:150px">Find By Message</td>
            <td style="min-width:250px"><input type="text" name="message" placeHolder="Hello World" value="<?=$_REQUEST['message']?>" style="width:200px; text-align: center;"></td>
        </tr>
        <tr>
            <td>Log Location</td>
            <td>
