...
<body>
	...
	<form action="updateaccount.php" method="post">
		<table align="center" border="1" cellpadding="5" width="450">
			...
			<tr>
				<td>Realname:</td>
				<td><input type="text" value="<?=$current_realname?>" name="realname" size="35" maxlength="35" /></td>
			</tr>
			<tr>
				<td>Gender:</td>
				<td>
					...
					{
						if ($current_gender == $gender_option_array[$i][0])
			...
			<tr>
				<td>Password:</td>
				<td><input type="password" value="<?=$current_password?>" name="password_sha512" size="35" maxlength="120" /></td>
			</tr>
			<tr>
				<td>Email:</td>
				<td><input type="text" value="<?=$current_email?>" name="email" size="35" maxlength="255" /></td>
			</tr>
			<tr>
				<td>Country:</td>
				<!--<td><input type="text" value="<?=$current_country?>" name="country" size="35" maxlength="2" /></td>-->
				<td>
					<select name="country">
				<?php
					...
					{
						if ($current_country == $all_countries_short_array[$i])
			...
			<tr>
				...
				<td><?='<img src="data:image/png;base64,' . base64_encode($current_avatar) . '"/>';?></td>
			</tr>
			<tr>
				<td>Delete Avatar:</td>
			...
			<?php
				if ($_SESSION['admin'] > 0)
				{
					echo '<tr>'.
						'<td>Admin Notes:</td>'.
						'<td>'.
					 	'<textarea name="adminnotes" rows="8" cols="35" />' . $current_adminnotes . '</textarea>'.
						'</td>'.
					 	'</tr>';
				}
			?>	
